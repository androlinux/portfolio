...
const fieldGroups = [
  ...
  { title: 'Skills & languages',keys: ['skillsNum','skillsTitle','skillsSub','s1','s2','s3','s4','s5','s6','s7','s12','s13','s14','s15','langSub','l1n','l1v','l2n','l2v','l3n','l3v','l4n','l4v','l5n','l5v'] },
...
const longFields = ['heroRole','profileText','p1text','p2text','p3text','cookieText'];
